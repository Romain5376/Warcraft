    ...
    <div class="row fightRow">
        <?php if (isset($revenant)) { ?>
            <div class="col s12 col m12 col l5 center">
                <div class="card cardFight z-depth-5">
                    ...
                    <?= $_SESSION['enemyImg'] = "img/zombie.jpg" ?>
                    <img src="img/zombie.jpg" /> 
                    <?= $_SESSION['enemyName'] = "Le Revenant" ?>
                        <span class="card-title">Le Revenant</span>
                        <?= $_SESSION['enemyRage'] = 20 ?>
                    </div>
        ...
        <?php } else if (isset($urukHaï)) { ?>
            ...
            <div class="col s12 col m12 col l5 center">
                <div class="card cardFight z-depth-5">
                    <div class="card-image">
                    <?= $_SESSION['enemyImg'] = "img/uruk.jpg" ?>
                        <img src="img/uruk.jpg" />
                        <?= $_SESSION['enemyName'] = "L'Uruk Haï" ?>
        ...
        <?php } else if (isset($coronaviras)) {  ?>
            ...
            <div class="col s12 col m12 col l5 center">
                <div class="card cardFight z-depth-5">
                    <div class="card-image">
                    <?= $_SESSION['enemyImg'] = "img/coronaviras.jpg" ?>
                        <img src="img/coronaviras.jpg" />
                        <?= $_SESSION['enemyName'] = "Le Coronaviras" ?>
        ...
        <?php } else if (isset($bug)) { ?>
            ...
            <div class="col s12 col m12 col l5 center">
                <div class="card cardFight z-depth-5">
                    <div class="card-image">
                    <?= $_SESSION['enemyImg'] = "img/bug.jpg" ?>
                        <img src="img/bug.jpg" />
                        <?= $_SESSION['enemyName'] = "Le Bug" ?>
                        <span class="card-title">Le Bug</span>
                        <?= $_SESSION['enemyRage'] = 5 ?>
                    </div>
                    <div class="card-content">
        ...
        <?php if (isset($_POST['paladin'])) { ?>
            ...
            <div class="col s12 col m12 col l5 center">
                <div class="card cardFight z-depth-5">
                    <div class="card-image">
                    <?= $_SESSION['heroImg'] = "img/paladin.jpg" ?>
                        <img src="img/paladin.jpg" />
                        <?= $_SESSION['heroName'] = "Le Paladin" ?>
                        <span class="card-title">Le Paladin</span>
                        <?= $_SESSION['heroRage'] = 30 ?>
                    </div>
                    <div class="card-content">
...
<?php } else if (isset($_POST['wizard'])) { ?>
    ...
    <div class="col s12 col m12 col l5 center">
        <div class="card cardFight z-depth-5">
            <div class="card-image">
            <?= $_SESSION['heroImg'] = "img/mage.jpg" ?>
                <img src="img/mage.jpg" />
                <?= $_SESSION['heroName'] = "Le Mage" ?>
                <span class="card-title">Le Mage</span>
                <?= $_SESSION['heroRage'] = 20 ?>
            </div>
            <div class="card-content">
...
<?php } else if (isset($_POST['thief'])) { ?>
    ...
    <div class="col s12 col m12 col l5 center">
        <div class="card cardFight z-depth-5">
            <div class="card-image">
            <?= $_SESSION['heroImg'] = "img/voleur.jpg" ?>
                <img src="img/voleur.jpg" />
                <?= $_SESSION['heroName'] = "Le Voleur" ?>
...
<?php } else if (isset($_POST['webDeveloper'])) { ?>
    ...
    <div class="col s12 col m12 col l5 center">
        <div class="card cardFight z-depth-5">
            <div class="card-image">
            <?= $_SESSION['heroImg'] = "img/dev.jpg" ?>
                <img src="img/dev.jpg" />
                <?= $_SESSION['heroName'] = "Le Développeur Web" ?>
                <span class="card-title">Le Développeur Web</span>
                <?= $_SESSION['heroRage'] = 40 ?>
            </div>
            <div class="card-content">
